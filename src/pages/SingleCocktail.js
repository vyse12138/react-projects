...
const SingleCocktail = () => {
    ...
    return (
        <div className='container bg-light border-top-0 shadow pt-4 pb-2'>
            <img src={image} alt={name} width='500px' height='500px'/>
            <h1>
                {name}
            </h1>
            <p>
                <span className='font-weight-bold'>Type: </span>{category}/{info}
            </p>

            <p>
                <span className='font-weight-bold'>Glass: </span>{glass}
            </p>
            <p>
                <span className='font-weight-bold'>Instruction: </span>{instruction}
            </p>
